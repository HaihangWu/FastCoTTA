_base_ = [
    ...
    '../_base_/datasets/night_cityscapes_1024x1024_repeat.py',
...
model = dict(
    type='SegLanguage',
    #pretrained='../mmsegmentation/segformer.b0.1024x1024.city.160k.pth',
    pretrained='work_dirs/Lsegformer.b0.1024x1024.city.160k/iter_16000.pth',
    backbone=dict(
        type='mit_b0',
        style='pytorch'),
    decode_head=dict(
