...
class TextSETRHead(BaseDecodeHead):
    ...
    def __init__(self,
        ...
        super(TextSETRHead, self).__init__(init_cfg=init_cfg, **kwargs)
        ...
        self.linear_pred = nn.Conv2d(out_channels, self.num_classes, kernel_size=1)
