...
from mmseg.apis import multi_gpu_test, single_gpu_test, single_gpu_language_cotta_xiao
...
def main():
    ...
    for i in range(10):
        ...
        for dataset, data_loader in zip(datasets, data_loaders):
            ...
            outputs,frame_passed,domains_detections = single_gpu_language_cotta_xiao(model, data_loader, args.show, args.show_dir,
